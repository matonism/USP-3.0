	  	...
	  	$.ajax({
		    ...
		    success: function(php_script_response){
		    	if(php_script_response != 0){
		    		...
		    		document.querySelector("#username-display").html(php_script_response);
		    		attemptLogout();
		    		return 1;
		    	}else {
...
function attemptLogout(){
	...
	document.querySelector(document).ready(function(){
	  document.querySelector('.logout-action').click(function() { 
		$.ajax({
		    type: "POST",
	...
	document.querySelector(document).ready(function() {
	    document.querySelector('#loginForm').submit(function(e) {
	        ...
	        var method = $form[0].method;
	 		var username = document.querySelector('input[name="login-username"]').val();
	 		var password = document.querySelector('input[name="login-password"]').val();
